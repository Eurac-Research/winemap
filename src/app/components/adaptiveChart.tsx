    ...
    () => ({
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          const dimension = params[0]?.value?.[1] as string | undefined;
          const text = dimension ? TOOLTIP_TEXT[dimension] : "";

          return `<strong>${dimension} dimension</strong><br/>
