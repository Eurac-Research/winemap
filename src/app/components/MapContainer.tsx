...
import VulnerabilityDot from "./vulnerabilityDot";
...
interface MapContainerProps {
  viewType: "climate" | "adaptation" | "legal";
}

export default function MapContainer({ viewType }: MapContainerProps) {
  ...
  const sidebarLayoutIndex = hasSidebar ? 0 : -1;
