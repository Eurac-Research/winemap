  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[color:var(--page-bg)] text-[color:var(--text-strong)]">
      <section className="relative isolate overflow-hidden">
        ...
        />
        <div className="absolute inset-0 z-10 bg-[linear-gradient(180deg,rgba(12,16,20,0.2)_0%,rgba(12,16,20,0.28)_22%,rgba(245,241,235,0.2)_58%,rgba(255,255,255,0.96)_100%)]" />
        <div className="absolute inset-x-0 bottom-0 z-10 h-40 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.98)_100%)]" />
          ...
          <div className="mt-auto flex justify-center min-[1700px]:mt-15 min-[1700px]:pt-16">
            <div className="z-50 max-w-3xl rounded-xl shadow-xl bg-background/30 px-4 py-6 text-center sm:px-6 sm:py-8">
              <div>
                ...
                <p className="mb-4 flex items-center justify-center gap-2 text-xl font-light text-[color:var(--text-strong)] md:text-2xl">
                  by
                  <svg
