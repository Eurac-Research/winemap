...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen text-[color:var(--text-strong)] p-0 overflow-x-hidden">
      ...
      {/* <div
        ...
        style={{
          background: 'radial-gradient(circle at center, rgba(255,255,255,0.25) 0%, rgba(247,244,239,0.58) 38%, rgba(241,236,229,0.8) 68%, rgba(234,228,220,0.92) 100%)',
          backgroundAttachment: 'fixed',
        }}
      /> */}
        ...
        <div className="h-full px-6 md:px-12">
          <div className="mx-auto flex max-w-9xl justify-center">
            <div className="max-w-3xl text-center z-50 border bg-background/30">
              ...
              <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-[color:var(--text-base)]">
      ...
      <div className="relative z-20 w-full">
        <div className="relative z-20 w-full">
          ...
          {/* Map-Applications */}
          <section id='map-applications' className="px-4 py-20 max-w-4xl mx-auto border-t border-[color:var(--border-soft)]">
          ...
          {/* About Section */}
          <section className="px-4 py-20 max-w-4xl mx-auto border-t border-[color:var(--border-soft)]">
            <div className="text-center">
