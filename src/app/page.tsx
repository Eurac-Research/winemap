...
export default function HomePage() {
  return (
    ...
    {/* Sticky Hero Section */}
    <section className="sticky top-0 z-10 flex h-screen items-center justify-center px-4">
      ...
      <div className="relative z-20 w-full -mt-[100vh] bg-black min-h-screen">
        ...
        <div className="relative z-20 w-full">
          ...
          <section className="relative z-30 px-4 pb-12 max-w-5xl mx-auto bg-black/90 backdrop-blur-xl rounded-3xl mt-4">
            <div className="space-y-6">
              ...
              <div id="climate-environment" className="group relative bg-gradient-to-br from-white/10 to-white/5 border border-white/20 hover:border-[#E91E63] transition-all duration-300 overflow-hidden backdrop-blur-md rounded-xl shadow-xl hover:shadow-[#E91E63]/20 mt-8">
