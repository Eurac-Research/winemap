  ...
  return (
    <div className="relative min-h-screen text-white flex flex-col items-center p-6 overflow-hidden">
      ...
      <div className="relative z-20 w-full">
        ...
        {/* Institute Section */}
        <section className="px-4 py-20 max-w-6xl mx-auto border-t border-white/10">
          <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden backdrop-blur-md">
            <div className="p-12">
              ...
              <h2 className="text-3xl font-bold text-white mb-4">Institute for Alpine Environment</h2>
