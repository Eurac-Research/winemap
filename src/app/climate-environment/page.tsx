  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        {/* Sidebar */}
        <div className="fixed left-0 top-0 h-full w-96 bg-black bg-opacity-90 text-white overflow-y-auto z-10">
          {/* Winemap Header */}
          <header className="flex px-[30px] py-[20px] items-center gap-2 bg-black">
            <Link
              href="/"
              className="pb-[3px] text-white hover:[text-shadow:_0_0_10px_rgb(255_255_255)] transition-all"
            >
              WINEMAP{" "}
              <span className="font-extralight italic uppercase mr-1">Environment</span>{" "}
              by
            </Link>
          ...
          <div className="px-6 py-4 border-b border-gray-600">
            <h1 className="text-lg font-bold">ECOLOGICAL CONDITIONS AND ECOSYSTEM SERVICES IN THE ALPS</h1>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <Tabs
                ...
                items={layerGroups.map(group => ({
                  key: group.id,
                  label: group.id === 'ecosystem-conditions' ? 'Ecosystem Conditions' : 'Ecosystem Services',
                }))}
              />
            </div>
            ...
            <div className="border-t border-gray-600 pt-6">
              <div className="mb-4">
                <h3 className="text-lg font-medium mb-2">{selectedLayer.name}</h3>
              ...
              {selectedLayer.references && (
                <div className="mb-4">
                  <h4 className="text-md font-medium mb-2">References:</h4>
              ...
              {selectedLayer.inputData && (
                <div>
                  <h4 className="text-md font-medium mb-2">Input Data:</h4>
                  <ul className="text-xs text-gray-400 space-y-1">
