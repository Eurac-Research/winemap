...
const layerGroups: LayerGroup[] = [
  {
    ...
    description:
      "Ecosystem conditions: the overall quality of an ecosystem to reflect its health and ability to provide ecosystem services",
    layers: [
      {
...
export default function EnvironmentalPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.log(
        `Selected layer ${selectedLayer.mapboxLayerId} not found in map style`,
      );
    }
        ...
        <div className={styles.contentFrame}>
          <div className={styles.frontpageContent}>
            ...
            <h2 className="text-xl font-semibold mb-6">
              ECOLOGICAL CONDITIONS AND ECOSYSTEM SERVICES IN THE ALPS
            </h2>
              ...
              <div className="flex bg-white bg-opacity-10 rounded-lg p-1 w-fit gap-1">
                {layerGroups.map((group) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all !mt-0 duration-200 ${
                      selectedGroupId === group.id
                        ? "bg-white text-black shadow-sm"
                        : "text-white hover:bg-white hover:bg-opacity-20"
                    }`}
                  >
                    {group.id === "ecosystem-conditions"
            ...
            <div className="mb-6">
              ...
              >
                {selectedGroup.layers.map((layer) => (
                  <Radio key={layer.id} value={layer.id} className="text-white">
            ...
            <div className="border-t border-gray-600 pt-6 pb-10">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">
                  The data presented were produced within the project AGATA
                  (Accessible ecoloGicAl daTA for resilient Viticulture),
                  jointly financed by Eurac Research and the University of
                  Verona as part of the &ldquo;JOINT RESEARCH 2022&rdquo; Call.
                </p>
              </div>
            </div>
          </div>
