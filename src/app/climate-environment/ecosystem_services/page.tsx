        ...
        <article className="space-y-12">
          <section className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/10 to-white/5 p-8 md:p-12">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <a href="#pollination" className="rounded-lg border border-white/15 bg-black/30 px-4 py-2 text-sm font-medium text-white/85 transition-colors hover:border-[#E91E63] hover:text-white">
                Pollination
              </a>
              <a href="#erosion-control" className="rounded-lg border border-white/15 bg-black/30 px-4 py-2 text-sm font-medium text-white/85 transition-colors hover:border-[#E91E63] hover:text-white">
                Soil Erosion Control
              </a>
            </div>
          </section>
          
          <section id="pollination" className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/10 to-white/5 p-5 md:p-8">
            <h3 className="text-2xl font-semibold text-white">Pollination</h3>
          ...
          <section id="erosion-control" className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/10 to-white/5 p-5 md:p-8">
            <h3 className="text-2xl font-semibold text-white">Soil Erosion Control</h3>
            <p className="mt-2 text-sm text-white/60">Thermal growing conditions and ripening suitability</p>
            ...
            <CollapsiblePanel title="References">
              <ul className="mt-4 space-y-3 text-white/80">
                ...
                <li>Laaich, H. et al. (2016). Soil erodibility mapping using three approaches in the Tangiers province –Northern Morocco. International Soil and Water Conservation Research (4), 159–167.</li>
