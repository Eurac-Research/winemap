        ...
        <article>
          ...
          <div className="article-body">
            ...
            <a
              ...
              download
              className="article-action-link inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition border-[color:var(--accent)] app-accent-text hover:bg-[color:var(--accent-soft)]"
            >
